...
public final class MapMarkerUIView: UIView {
	private enum Constants {
		static let labelOffset: CGFloat = 10
		static let labelMaxWidth: CGFloat = 200
		static let titleBlizzardColor = UIColor(named: "colors/marker_title")
		static let titleFont = UIFont.systemFont(ofSize: 18, weight:.bold)
		static let subtitleGrayColor = UIColor(named: "colors/marker_subtitle")
	...
	private let viewModel: MapMarkerUIViewModel
	...
	init(viewModel: MapMarkerUIViewModel) {
...
private extension MapMarkerUIView {
	func setupView() {
