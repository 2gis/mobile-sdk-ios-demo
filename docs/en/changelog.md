...
- Реализован протокол `ITerritoryManager` для скачивания offline-территорий.
- Добавлен `INavigationVoice` для выбора озвучки навигатора. Реализован плагин `IVoiceSelector` для выбора голоса навигатора.
- Реализован протокол `IVoiceManager` для взаимодействия со списком голосовых пакетов навигатора.
